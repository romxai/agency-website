    ...
    >
      ...
      <div className="container relative z-10">
        ...
        <div className="relative">
          <div
            className={`grid grid-cols-3 gap-x-4 gap-y-16 transition-all duration-1000 ease-out ${
          ...
          >
            {clientLogos[currentSet].map((client, index) => (
              <div
                ...
                className="flex items-center justify-center p-2 transition-all duration-300" // Removed hover:scale-125
              >
                {/* SVG Logo from file */}
                <img
                  src={client.logo}
                  ...
                  className="w-8 h-8 md:w-12 md:h-12 object-contain text-[#FFED99] opacity-75 hover:opacity-100 transition-opacity duration-300"
